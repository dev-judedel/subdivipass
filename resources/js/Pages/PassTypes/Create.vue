        ...
        <div class="bg-white shadow">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Create Pass Type</h1>
                        <p class="mt-1 text-sm text-gray-500">Define a new type of pass for your subdivision</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    >
                        ...
                        <span v-else>Create Pass Type</span>
                    </button>
                </div>
            </form>
        </div>
...
const submit = () => {
    form.post(route('pass-types.store'), {
        preserveScroll: true,
    });
};
</script>
