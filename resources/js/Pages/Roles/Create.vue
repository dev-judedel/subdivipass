<template>
    <div class="space-y-8">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <p class="text-sm font-semibold text-blue-600 uppercase tracking-wide">New Role</p>
                <h1 class="text-3xl font-bold text-gray-900 mt-1">Create Role</h1>
                <p class="text-sm text-gray-500 mt-1">Name the role and assign the permissions it should own.</p>
            </div>
            <Link
