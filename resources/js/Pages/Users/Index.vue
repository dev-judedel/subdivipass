                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex justify-end gap-2">
                                        <Link
                                            ...
                                            class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-semibold border border-gray-200 text-gray-700 hover:bg-gray-50"
                                        >
                                            View
                                        </Link>
                                        <Link
                                            :href="route('users.edit', user.id)"
                                            class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-semibold border border-blue-200 text-blue-700 hover:bg-blue-50"
                                        >
                                            Edit
                                        </Link>
                                        <button
                                            type="button"
                                            class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-semibold border border-red-200 text-red-600 hover:bg-red-50"
